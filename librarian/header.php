...
$tot=0;
$res=mysqli_query($link,"select * from messages where dusername='' && read1='n'");
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    ...
                    <div class="profile_info">
                        ...
                        <h2><?php
                            $res=mysqli_query($link,"select * from librarian_registration where username='$_SESSION[librarian]'");
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="books_details_with_student.php"><i class="fa fa-dropbox"></i>Books with all info<span
                                            class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="send_notification_student.php"><i class="fa fa-mail-forward"></i>Send message<span
                                            class="fa fa-chevron-down"></span></a>
