                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="search_books.php"><i class="fa fa-dropbox"></i>Search books <span class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="send_request.php"><i class="fa fa-mail-reply"></i>Send request<span
